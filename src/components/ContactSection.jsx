...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-paint-gloss text-white border-b border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Contact Card */}
            <div className="bg-black/50 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 space-y-5 shadow-xl">
              
              <div>
                <h3 className="text-xl font-black text-white">Pro Colour Smart Repair</h3>
                <p className="text-xs text-amber-400 font-semibold mt-0.5">Inhaber: Jens Rüsch</p>
              </div>
            ...
            {/* Google Maps Frame (Restored cleanly) */}
            <div className="rounded-3xl overflow-hidden border border-white/10 h-64 bg-dark-900 shadow-xl relative">
              <iframe
          ...
          <div className="lg:col-span-7">
            <div className="bg-black/50 backdrop-blur-xl rounded-3xl p-6 sm:p-9 border border-white/10 shadow-xl">
              ...
              {submitted ? (
                <div className="py-14 text-center space-y-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Anfrage erfolgreich versendet!</h3>
                  ...
                  <button
                    ...
                    className="mt-3 px-6 py-2.5 rounded-xl bg-dark-900 border border-white/15 text-xs font-bold text-white hover:border-brand-orange cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-left">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-300 mb-1">Telefonnummer *</label>
                      <input
                        type="tel"
                        required
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs text-slate-300 font-semibold">
                      ...
                      {uploadedFiles.length > 0 && (
                        <span className="text-[11px] text-amber-400">{uploadedFiles.length}/3 ausgewählt</span>
                      )}
                    </div>

                    <label className="border border-dashed border-white/20 hover:border-brand-orange/60 bg-[#12151C]/60 hover:bg-[#12151C] rounded-xl p-3.5 flex items-center justify-center gap-2.5 cursor-pointer transition-colors">
                  ...
                  <button
                    type="submit"
                    className="btn-3d-luxury w-full py-3.5 px-6 text-white font-extrabold text-sm rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-lg mt-2"
                  >
                  ...
                  <div className="pt-1 text-center text-xs text-slate-400">
                    Oder direkt per WhatsApp: <a href="https://wa.me/491702025130" target="_blank" rel="noopener noreferrer" className="text-amber-400 font-bold hover:underline">0170 2025130</a>
                  </div>
                </form>
              )}
